...
st.write("Upload an image or take a photo with the camera, and the model will predict the object in the image and visualize important regions using Grad-CAM.")
